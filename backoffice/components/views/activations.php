        ...
        <div class="col-12">
            ...
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Список заявок на активацию парковок</h3>
                </div>
                <!-- /.card-header -->
                <div class="card-body">
                    ...
                    <table class="table table-bordered table-striped data_table">
                        ...
                        <?php foreach ($parkings as $parking):?>
                            <tr><td><?=$parking->id?></td>
                                ...
                                <td><p data-placement="top" data-toggle="tooltip" title="Активировать">

                                        <?=Html::a(' <button class="btn btn-block btn-danger" data-title="activate" >Активация </button>',
                                            ['/parkings/activations','id'=>$parking->id],['classs'=>'activate'])?>
                                    </p></td>
                            </tr>
                        <?php endforeach;?>
                    </table>
                    ...
                    <?php else:?>
                        <h4># В данный момент заявок нет...</h4>
                    <?php endif;?>
                </div>
                <!-- /.card-body -->
            </div>
